...
sbatch --partition=3090-lo  --exclusive --mem=0 --gres=gpu:1 --job-name=Interactive4d_Kitti360_30m_validation3 --time=4-00:00:00 \
--signal=TERM@120 --mail-user=ilya.fradlin@rwth-aachen.de --mail-type=BEGIN,END,FAIL --output=outputs/%j_Interactive4d_Kitti360_30m_validation3.txt evaluate.sh